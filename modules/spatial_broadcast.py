...
class VAE_V2(nn.Module):
    def __init__(self, in_shape, n_latent):
        ...
        conv_output_dim = 64 * 8 * 8  # channels * height * width
        self.encoder_cnn = nn.Sequential(
            nn.Conv2d(c, 32, kernel_size=4, stride=2, padding=2),  # 32, 16, 16
            nn.ReLU(),
            nn.Conv2d(32, 32, kernel_size=4, stride=2, padding=2),  # 32, 8, 8
            nn.ReLU(),
